...
یک دستیار صوتی هوشمند برای ویندوز با قابلیت تشخیص گفتار آنی بر پایه موتور Vosk، شامل ویژگی‌های زیر:
- تبدیل زنده گفتار به متن به زبان‌های فارسی و انگلیسی  
- پشتیبانی از فرمان‌های صوتی سفارشی و علائم نگارشی
- رابط کاربری بومی و یکپارچه با WinUI 3  
[مشاهده پروژه Roozegaar Voice Assistant ←](https://github.com/MEHDIMYADI/RoozegaarVoiceAssistant-Releases)
